...
# --- In this example, we use the Metropolis algo to decode a cipher --- #
...
# get corpus about a badass detective
...
chars_to_remove = ['[', ']', '\n', '\r', '$', '#', '%', '*', '@', \
                   '&', '+', '<', '>', '=', '_', '{', '}', '|']
# clean the corpus
metro.clean_corpus(corpus, chars_to_remove, ngram = 2, groupby = 'chars')
print(metro.unique_symbols)
print(metro.target_plausibility)
